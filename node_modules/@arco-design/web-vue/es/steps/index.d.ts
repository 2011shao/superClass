...
declare const Steps: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "small" | "direction" | "status" | "current" | "defaultCurrent" | "labelPlacement" | "lineLess" | "changeable">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
