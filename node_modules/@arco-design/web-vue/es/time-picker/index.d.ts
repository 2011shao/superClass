...
declare const TimePicker: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "popupVisible" | "defaultPopupVisible" | "position" | "disabled" | "unmountOnClose" | "readonly" | "error" | "allowClear" | "format" | "disableConfirm" | "use12Hours" | "hideDisabledOptions">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
